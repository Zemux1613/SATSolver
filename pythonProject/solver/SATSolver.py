...
input_formula = "(x & y) | (-x & z) | (y & -z) | (-y & x)"  # input("input formula: ")
...
def results():
    """
    Gibt das Ergebnis des 2-SAT-Problems und die Formel aus.
    """
    start = current_milli_time()
    if two_sat_solver.solve_2SAT():
        ...
        print("Formula:", two_sat_solver.formula[:-2])  # Letzte zwei Zeichen entfernen (um '&' am Ende zu entfernen)
    else:
